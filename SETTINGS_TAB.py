...
_FIELDS = [
    ...
    ("show_notifications", "Desktop notifications (0=off, 1=on)",
     "int", 0, 1,
     "Show a desktop notification when a relic reward is detected. Disable if it pulls focus away from Warframe."),
