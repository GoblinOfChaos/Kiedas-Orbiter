...
with open('/var/home/jedwards/kiedas-orbiter/docs/revamp/stage-2/evidence/native-embedded-build.log','w') as log:
    result=subprocess.run(['nice','-n','19','/home/jedwards/.cargo/bin/cargo','build','--manifest-path','src-tauri/Cargo.toml','--features','preview,tauri/custom-protocol','--offline'],env=env,stdout=log,stderr=subprocess.STDOUT)
