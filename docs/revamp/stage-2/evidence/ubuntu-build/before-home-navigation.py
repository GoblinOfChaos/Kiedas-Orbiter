...
try:
 ...
 click('Choose source folder');window=x.wait(title);x.focus(window);x.key(ord('l'),0xffe3);time.sleep(.3);x.key(ord('a'),0xffe3);x.text(str(source));time.sleep(.5);x.key(0xff0d);time.sleep(3)
