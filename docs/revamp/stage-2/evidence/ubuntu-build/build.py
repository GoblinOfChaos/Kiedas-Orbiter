...
with open(root.parent.parent/'docs/revamp/stage-2/evidence/ubuntu-native-build.log','w') as log:
 r=subprocess.run(['nice','-n','19','cargo','build','--manifest-path','src-tauri/Cargo.toml','--features','preview,tauri/custom-protocol','--offline','--locked'],cwd=root,env=env,stdout=log,stderr=subprocess.STDOUT)
