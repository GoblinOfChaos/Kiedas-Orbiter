...
STABLE_DIST = ROOT / '.preview-work/stage3-maps/stable-dist'
...
jobs = [
    ('production', STABLE_DIST, EVIDENCE / 'maps-frontend-stable.log'),
    ('preview', APP / 'dist', EVIDENCE / 'maps-frontend-preview.log'),
]
