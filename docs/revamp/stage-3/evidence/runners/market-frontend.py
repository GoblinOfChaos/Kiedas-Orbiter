...
STABLE_DIST = ROOT / '.preview-work/stage3-market/stable-dist'
...
jobs = [
    ('production', STABLE_DIST, EVIDENCE / 'market-frontend-stable.log'),
    ('preview', APP / 'dist', EVIDENCE / 'market-frontend-preview.log'),
]
