...
for mode,out,name in [('production',str(root/'.preview-work/stage3-inventory/stable-dist'),'mastery-frontend-stable.log'),('preview','dist','mastery-frontend-preview.log')]:
