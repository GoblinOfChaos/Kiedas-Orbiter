...
STABLE_DIST = ROOT / '.preview-work/stage3-relic-planner/stable-dist'
...
jobs = [
    ('production', STABLE_DIST, EVIDENCE / 'relic-planner-frontend-stable.log'),
    ('preview', APP / 'dist', EVIDENCE / 'relic-planner-frontend-preview.log'),
]
