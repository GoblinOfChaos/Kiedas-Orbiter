...
STABLE_DIST = ROOT / '.preview-work/stage3-relics/stable-dist'
...
jobs = [
    ('production', STABLE_DIST, EVIDENCE / 'relics-frontend-stable.log'),
    ('preview', APP / 'dist', EVIDENCE / 'relics-frontend-preview.log'),
]
