...
import { buildRecipeResultIndex, buildMarketIndex, buildBundleIndex, buildVendorIndex } from '../lib/acquisitionInfo'
...
export function MonitoringProvider({ children }) {
  ...
  const vendorIndex = useMemo(() => buildVendorIndex(exportData), [exportData])
...
const hasCachedData = useCallback(async () => {
  ...
  return (
    <MonitoringContext.Provider value={{
      ...
      dict, suppDict, EC, ERg, EI, nameToImage, uniqueNameToName, ES, ENW, ENWRawRewards, ExportImages, ExportTextIcons, arbyTiers: ARBY_TIERS, dropIndex, recipeResultIndex, marketIndex, bundleIndex, vendorIndex,
