      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 w-full">
        {items.map((it, idx) => (
          ...
          >
            ...
            {/* Darken the left transparent zone so overlaid text stays legible; portrait occupies the right ~45% */}
            <div className="absolute inset-0 left-0 right-[45%] bg-gradient-to-r from-black/65 via-black/40 to-transparent" />
            {/* Text spans the transparent-left region but never crosses into the portrait */}
            <div className="absolute inset-0 left-0 right-[55%] flex flex-col justify-between p-3 z-10">
