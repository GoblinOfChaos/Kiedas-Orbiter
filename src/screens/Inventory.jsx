...
export default function Inventory() {
  ...
  const { inventoryData, isInventoryLoading, allPrices, isPriceLoading, priceFetchProgress, dropIndex, recipeResultIndex, marketIndex, ExportImages, ExportTextIcons, cardImagesPath } = useMonitoring();
  ...
  const openItem = useMemo(() => {
    ...
    if (!item) return null;
    return { displayName: item.name, info: getAcquisitionInfo(item.unique_name, item.name, dropIndex, acquisitionOverrides, recipeResultIndex, marketIndex) };
  }, [openKey, acquisitionDataReady, visibleItems, dropIndex, acquisitionOverrides, recipeResultIndex, marketIndex]);
