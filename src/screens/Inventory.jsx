...
export default function Inventory() {
  ...
  const { inventoryData, isInventoryLoading, allPrices, isPriceLoading, priceFetchProgress, dropIndex, recipeResultIndex, marketIndex, alwaysAvailableIndex, bundleIndex, syndicateIndex, wikiSigilIndex, exportVendorIndex, ExportImages, ExportTextIcons, cardImagesPath } = useMonitoring();
