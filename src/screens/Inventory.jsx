...
export default function Inventory() {
  ...
  const { inventoryData, isInventoryLoading, allPrices, isPriceLoading, priceFetchProgress, dropIndex, recipeResultIndex, marketIndex, bundleIndex, syndicateIndex, ExportImages, ExportTextIcons, cardImagesPath } = useMonitoring();
  ...
  const openItem = useMemo(() => {
    ...
    if (!item) return null;
    return { displayName: item.name, info: getAcquisitionInfo(item.unique_name, item.name, dropIndex, acquisitionOverrides, recipeResultIndex, marketIndex, bundleIndex, syndicateIndex) };
  }, [openKey, acquisitionDataReady, visibleItems, dropIndex, acquisitionOverrides, recipeResultIndex, marketIndex, bundleIndex, syndicateIndex]);
