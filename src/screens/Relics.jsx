...
export default function Relics() {
  const { t } = useUi()
  const { inventoryData, exportData, isInventoryLoading, allPrices, isPriceLoading, priceFetchProgress, dropIndex, recipeResultIndex, marketIndex, bundleIndex, syndicateIndex } = useMonitoring();
  ...
  const openItem = useMemo(() => {
    ...
    if (!item) return null;
    const info = getAcquisitionInfo(item.unique_name, item.name, dropIndex, acquisitionOverrides, recipeResultIndex, marketIndex, bundleIndex, syndicateIndex);
  ...
  }, [openKey, acquisitionDataReady, grouped, dropIndex, acquisitionOverrides, recipeResultIndex, marketIndex, bundleIndex, syndicateIndex]);
